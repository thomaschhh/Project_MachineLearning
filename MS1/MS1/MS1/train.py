...
def main(args):
    ...
    # load the data
    dataloader, dataset_train, testL, dataset_test = load_data(args.path, args.bs, train_ratio = 0.5, test_ratio = 0.5)
    #load vgg
    ...
    for epoch in range(args.ep):
        ...
        features = compute_features(dataloader, model, len(dataset_train), args.bs)
